...
#if CONCORE_USE_CXX2020 && defined(__cpp_concepts)
#define CONCORE_CXX_HAS_CONCEPTS 1
#else
#define CONCORE_CXX_HAS_CONCEPTS 0
#endif

#if CONCORE_USE_CXX2020 && defined(__cpp_lib_concepts)
...
#if CONCORE_USE_CXX2020 && defined(__cpp_impl_coroutine)
#define CONCORE_CXX_HAS_COROUTINES 1
#else
#define CONCORE_CXX_HAS_COROUTINES 0
#endif

#if CONCORE_USE_CXX2020 && defined(__cpp_lib_coroutine)
...
#if CONCORE_USE_CXX2020 && defined(__has_include) && __has_include(<experimental/coroutine>)
...
#if CONCORE_USE_CXX2020 && defined(__cpp_modules)
